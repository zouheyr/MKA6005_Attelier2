...
## QUESTION 02 : Corrélation entre salaire et nombre d'années aprés le doctorat
...
On observe que dans les deux test le P-Value est de loins inférieur à 0.05, alors les résultats sont significatives statistiquement
